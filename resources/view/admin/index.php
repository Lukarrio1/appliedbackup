    ...
    <div class="row mt-5">
        <div class="col-md-6 mb-5">
            <div class="card bg-success">
                <div class="card-body">
                    ...
                    <div class="text-center text-white h5 dashboard" id="active_users">0</div>
        ...
        <div class="card bg-success">
                <div class="card-body">
                    ...
                    <div class="text-center text-white h5 dashboard" id="posts">0</div>
        ...
        <div class="card bg-danger">
                <div class="card-body">
                    ...
                    <div class="text-center text-white h5 dashboard" id="deleted_users">0</div>
        ...
        <div class="card bg-danger">
                <div class="card-body">
                    ...
                    <div class="text-center text-white h5 dashboard" id="reports">0</div>
